...
import 'package:intl/intl.dart'; // THÊM IMPORT ĐỂ FORMAT TIỀN TỆ
...
class _TonKhoPageState extends State<TonKhoPage> {
  String _searchQuery = '';
  final formatCurrency = NumberFormat.currency(locale: 'vi_VN', symbol: 'đ'); // Khởi tạo format tiền

  // Hàm hiển thị hộp thoại xác nhận gửi yêu cầu nhập hàng
  void _sendRestockRequest(String medicineName) {
    // Thêm Controller để Dược sĩ tự nhập số lượng muốn xin (Mặc định gợi ý 50)
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: 'Số lượng cần nhập (Hộp/Vỉ)',
                prefixIcon: const Icon(Icons.inventory, color: Colors.orange),
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Đã gửi yêu cầu nhập $requestQty $medicineName!'),
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> displayedMedicines = globalMedicines.where((m) {
    ...
    displayedMedicines.sort((a, b) {
      ...
      bool isLowA = stockA < 20;
      bool isLowB = stockB < 20;
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Tìm theo tên thuốc, mã SP, mã vạch...',
              ...
              children: [
                ...
                const Row(
                  children: [
                    ...
                    SizedBox(width: 4),
                    Text('Sắp hết (Tồn < 20)', style: TextStyle(color: Colors.redAccent, fontSize: 13, fontWeight: FontWeight.bold)),
                  ],
                )
              ],
            ),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  shape: RoundedRectangleBorder(
                      ...
                      side: BorderSide(color: isLowStock ? Colors.red.shade200 : Colors.transparent, width: 1.5)
                  ),
                  child: InkWell(
                    borderRadius: BorderRadius.circular(12),
